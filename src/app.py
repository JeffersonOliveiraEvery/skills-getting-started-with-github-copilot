...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming training, techniques, and friendly competitions",
        "schedule": "Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage performance, and school play productions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore creative painting techniques and visual expression",
